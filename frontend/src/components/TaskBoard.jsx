...
import { X, Edit, Eye, Search, Plus } from "lucide-react";
  ...
  return (
    <div className="p-4">
      <div className="mb-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <button
          className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 transition-colors w-full sm:w-auto flex items-center justify-center gap-2"
          onClick={addNewTask}
        >
          <Plus size={18} />
          Add Task
        ...
        <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
          <div className="relative w-full sm:w-64">
            ...
            <input
              ...
              className="border p-2 pl-9 rounded w-full focus:outline-none focus:ring-2 focus:ring-blue-500"
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)}
            />
          </div>
          <select
            className="border p-2 rounded w-full sm:w-auto bg-white focus:outline-none focus:ring-2 focus:ring-blue-500"
            value={sortBy}
